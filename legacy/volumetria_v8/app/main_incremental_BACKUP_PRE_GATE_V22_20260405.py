...
class PlasticHighORBRefiner:
    # V2.1:
    # - continua bloqueando borda / meia caçamba / boca fora do envelope
    # - deixa de reprovar sozinho por 'geometria_boca_exagerada'
    ...
    def _run_commercial_gate(self, warped_mask, floor, wall, img_shape):
        ...
        cand_border_touch, cand_border_flags = self._touches_border(cand)
        if cand_border_touch:
            return False, None, {
        ...
        support_border_touch, support_border_flags = self._touches_border(support)
