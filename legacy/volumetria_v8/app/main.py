...
def main():
    ...
    for img_path, img, opening, floor, wall in stage:
        ...
        # wall é salvo para auditoria, mas não entra no cálculo neste estágio
        _ = wall
    ...
    with open(CSV_DIR / "run_info.json", "w", encoding="utf-8") as f:
    ...
    print("RUN_INFO:", CSV_DIR / "run_info.json")
