...
# Modelos ficam dentro do próprio pacote piloto
MODEL_PATH = PRODUCT_ROOT / "models" / "best_pre_rotulagem_atual.pt"
CONTAMINANTES_MODEL_PATH = PRODUCT_ROOT / "models" / "contaminantes_rf_v1.pt"

# Máscaras estruturais esperadas
...
# Entrada configurável por variável de ambiente
